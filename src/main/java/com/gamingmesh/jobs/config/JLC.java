...
public enum JLC {
    ...
    command_limit_output_moneyLimitCurve("{gcp}Money limit: {gcs}[current]{gcp}/{gcs}[total] (Original: {gcs}[original]{gcp}) (Stage [stage])"),
    command_limit_output_moneyLimitCurveAbsolute("{gcp}Money limit: {gcs}[current]{gcp} (Absolute Cap Reached: {gcs}[total]{gcp})"),
    ...
    command_limit_output_reachedmoneylimit3("{gcp}Money earned is now reduced by [reduction] (New Limit: {gcs}[limit]{gcp})... But you still earn money from doing jobs!"),
    command_limit_output_reachedmoneyabsolute("{gcw}You have reached the absolute daily money limit of {gcs}[limit]{gcw}! You cannot earn any more money today until the limit resets."),
